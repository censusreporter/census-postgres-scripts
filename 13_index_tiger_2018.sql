...
ALTER TABLE tiger2018.cbsa OWNER TO census;
ALTER TABLE tiger2018.cd OWNER TO census;
ALTER TABLE tiger2018.county OWNER TO census;
ALTER TABLE tiger2018.csa OWNER TO census;
ALTER TABLE tiger2018.place OWNER TO census;
ALTER TABLE tiger2018.state OWNER TO census;
ALTER TABLE tiger2018.elsd OWNER TO census;
ALTER TABLE tiger2018.scsd OWNER TO census;
ALTER TABLE tiger2018.zcta5 OWNER TO census;
ALTER TABLE tiger2018.cousub OWNER TO census;
ALTER TABLE tiger2018.puma OWNER TO census;
ALTER TABLE tiger2018.sldl OWNER TO census;
ALTER TABLE tiger2018.sldu OWNER TO census;
ALTER TABLE tiger2018.aiannh OWNER TO census;
ALTER TABLE tiger2018.aitsn OWNER TO census;
ALTER TABLE tiger2018.anrc OWNER TO census;
ALTER TABLE tiger2018.bg OWNER TO census;
ALTER TABLE tiger2018.cnecta OWNER TO census;
ALTER TABLE tiger2018.concity OWNER TO census;
ALTER TABLE tiger2018.metdiv OWNER TO census;
ALTER TABLE tiger2018.necta OWNER TO census;
ALTER TABLE tiger2018.nectadiv OWNER TO census;
ALTER TABLE tiger2018.submcd OWNER TO census;
ALTER TABLE tiger2018.tbg OWNER TO census;
ALTER TABLE tiger2018.ttract OWNER TO census;
ALTER TABLE tiger2018.tract OWNER TO census;
ALTER TABLE tiger2018.uac OWNER TO census;
ALTER TABLE tiger2018.unsd OWNER TO census;
...
DROP TABLE IF EXISTS tiger2018.census_name_lookup;
CREATE TABLE tiger2018.census_name_lookup (
...
SELECT AddGeometryColumn('tiger2018', 'census_name_lookup', 'geom', 4326, 'MULTIPOLYGON', 2);
...
CREATE INDEX census_name_lookup_idx_lower ON tiger2018.census_name_lookup ((lower(prefix_match_name)) text_pattern_ops);
CREATE INDEX census_name_lookup_idx_geom ON tiger2018.census_name_lookup USING GIST(geom);
CREATE INDEX census_name_lookup_idx_geoid ON tiger2018.census_name_lookup (full_geoid);
CREATE INDEX census_name_lookup_idx_sumlevel ON tiger2018.census_name_lookup(sumlevel);

CREATE TABLE tiger2018.census_geo_containment (
...
INSERT INTO tiger2018.census_geo_containment (
    ...
    FROM tiger2018.place
    JOIN tiger2018.county ON ST_Intersects(place.geom, county.geom)
    WHERE
...
INSERT INTO tiger2018.census_geo_containment (
    ...
    FROM tiger2018.zcta5
    JOIN tiger2018.county ON ST_Intersects(zcta5.geom, county.geom)
    WHERE
...
INSERT INTO tiger2018.census_geo_containment (
    ...
    FROM tiger2018.elsd
    JOIN tiger2018.county ON ST_Intersects(elsd.geom, county.geom)
    WHERE
...
INSERT INTO tiger2018.census_geo_containment (
    ...
    FROM tiger2018.scsd
    JOIN tiger2018.county ON ST_Intersects(scsd.geom, county.geom)
    WHERE
...
INSERT INTO tiger2018.census_geo_containment (
    ...
    FROM tiger2018.unsd
    JOIN tiger2018.county ON ST_Intersects(unsd.geom, county.geom)
    WHERE
...
INSERT INTO tiger2018.census_geo_containment (
    ...
    FROM tiger2018.place
    JOIN tiger2018.cbsa ON ST_Intersects(place.geom, cbsa.geom)
    WHERE
...
INSERT INTO tiger2018.census_geo_containment (
    ...
    FROM tiger2018.zcta5
    JOIN tiger2018.cbsa ON ST_Intersects(zcta5.geom, cbsa.geom)
    WHERE
        ST_IsValid(zcta5.geom) AND
...
INSERT INTO tiger2018.census_geo_containment (
    ...
    FROM tiger2018.zcta5
    JOIN tiger2018.state ON ST_Intersects(zcta5.geom, state.geom)
    WHERE
        ST_IsValid(zcta5.geom) AND
...
INSERT INTO tiger2018.census_geo_containment (
    ...
    FROM tiger2018.cbsa
    JOIN tiger2018.state ON ST_Intersects(cbsa.geom, state.geom)
    WHERE
...
INSERT INTO tiger2018.census_geo_containment (
    ...
    FROM tiger2018.cbsa
    JOIN tiger2018.csa ON ST_Intersects(cbsa.geom, csa.geom)
    WHERE
        ST_IsValid(cbsa.geom) AND
...
INSERT INTO tiger2018.census_geo_containment (
    ...
    FROM tiger2018.csa
    JOIN tiger2018.state ON ST_Intersects(csa.geom, state.geom)
    WHERE
...
INSERT INTO tiger2018.census_geo_containment (
    ...
    FROM tiger2018.tract
    JOIN tiger2018.place ON ST_Intersects(tract.geom, place.geom)
    WHERE
...
INSERT INTO tiger2018.census_geo_containment (
    ...
    FROM tiger2018.bg
    JOIN tiger2018.place ON ST_Intersects(bg.geom, place.geom)
    WHERE
...
INSERT INTO tiger2018.census_geo_containment (
    ...
    FROM tiger2018.necta
    JOIN tiger2018.state ON ST_Intersects(necta.geom, state.geom)
    WHERE
...
CREATE INDEX census_geo_containment_idx_child_geoid ON tiger2018.census_geo_containment (child_geoid);
CREATE INDEX census_geo_containment_idx_parent_geoid ON tiger2018.census_geo_containment (parent_geoid);

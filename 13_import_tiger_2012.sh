...
sudo -u postgres psql -c "CREATE INDEX zcta5_idx_geoid10 ON tiger2012.zcta5 (geoid10);"
sudo -u postgres psql -c "CREATE INDEX cousub_idx_geoid ON tiger2012.cousub (geoid);"
sudo -u postgres psql -c "CREATE INDEX puma_idx_geoid10 ON tiger2012.puma (geoid10);"
...
sudo -u postgres psql -c "CREATE INDEX uac_idx_geoid10 ON tiger2012.uac (geoid10);"
sudo -u postgres psql -c "CREATE INDEX unsd_idx_geoid ON tiger2012.unsd (geoid);"
sudo -u postgres psql -c "CREATE INDEX vtd_idx_geoid10 ON tiger2012.vtd (geoid10);"

# Change ownership on the TIGER tables
sudo -u postgres psql -c "ALTER TABLE tiger2012.cbsa OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.cd OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.county OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.csa OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.place OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.state OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.elsd OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.scsd OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.zcta5 OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.cousub OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.puma OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.sldl OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.sldu OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.aiannh OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.aits OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.anrc OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.bg OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.cnecta OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.concity OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.metdiv OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.necta OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.nectadiv OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.submcd OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.tbg OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.ttract OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.tabblock OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.tract OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.uac OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.unsd OWNER TO census"
sudo -u postgres psql -c "ALTER TABLE tiger2012.vtd OWNER TO census"

...
sudo -u postgres psql -d census -c "DROP SCHEMA IF EXISTS tiger2014; CREATE SCHEMA tiger2014;"
sudo -u postgres psql -d census -c "ALTER SCHEMA tiger2014 OWNER TO census;"

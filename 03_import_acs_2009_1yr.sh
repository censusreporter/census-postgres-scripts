...
sed -i '1i SET search_path = acs2009_1yr, public;' *.sql
sudo -u postgres psql -c "DROP SCHEMA IF EXISTS acs2009_1yr; CREATE SCHEMA acs2009_1yr;"
...
sed -i "s/\/<census_upload_root>\/acs2009_1yr\/All_Geographies_Not_Tracts_Block_Groups/\/mnt\/tmp\/acs2009_1yr\/geog/" /home/ubuntu/census-postgres/acs2009_1yr/import_geoheader.sql
sed -i "s/\/<census_upload_root>\/acs2009_1yr\/All_Geographies_Not_Tracts_Block_Groups/\/mnt\/tmp\/acs2009_1yr\/group1/" /home/ubuntu/census-postgres/acs2009_1yr/import_sequences.sql
sed -i "s/\/<census_upload_root>\/acs2009_1yr\/Tracts_Block_Groups_Only/\/mnt\/tmp\/acs2009_1yr\/group2/" /home/ubuntu/census-postgres/acs2009_1yr/import_sequences.sql

...
INSERT INTO tiger2015.census_name_lookup
    SELECT
        ...
        state.awater,
        state.geom
    FROM tiger2015.state LEFT OUTER JOIN acs2015_1yr.b01003 ON (('04000US' || state.geoid) = b01003.geoid)
...
INSERT INTO tiger2015.census_name_lookup
    SELECT
        ...
        place.awater,
        place.geom
    FROM tiger2015.place LEFT OUTER JOIN acs2014_5yr.b01003 ON (('16000US' || place.geoid) = b01003.geoid) JOIN tiger2015.state USING (statefp)
    WHERE state.geoid NOT IN ('60', '66', '69', '78');
...
INSERT INTO tiger2015.census_name_lookup
    SELECT
        ...
        county.awater,
        county.geom
    FROM tiger2015.county LEFT OUTER JOIN acs2014_5yr.b01003 ON (('05000US' || county.geoid) = b01003.geoid) JOIN tiger2015.state USING (statefp)
    WHERE state.geoid NOT IN ('60', '66', '69', '78');
INSERT INTO tiger2015.census_name_lookup
    SELECT
        ...
        cousub.awater,
        cousub.geom
    FROM tiger2015.cousub LEFT OUTER JOIN acs2014_5yr.b01003 ON (('06000US' || cousub.geoid) = b01003.geoid) JOIN tiger2015.county USING (statefp, countyfp) JOIN tiger2015.state USING (statefp)
    WHERE state.geoid NOT IN ('60', '66', '69', '78');
INSERT INTO tiger2015.census_name_lookup
    SELECT
        zcta5.zcta5ce10,
        ...
        zcta5.awater10,
        zcta5.geom
    FROM tiger2015.zcta5 LEFT OUTER JOIN acs2014_5yr.b01003 ON (('86000US' || zcta5.geoid10) = b01003.geoid);
INSERT INTO tiger2015.census_name_lookup
    SELECT
        cbsa.namelsad,
        cbsa.name,
        ...
        cbsa.awater,
        cbsa.geom
    FROM tiger2015.cbsa LEFT OUTER JOIN acs2014_5yr.b01003 ON (('31000US' || cbsa.geoid) = b01003.geoid);
INSERT INTO tiger2015.census_name_lookup
    SELECT
        ...
        cd.awater,
        cd.geom
    FROM tiger2015.cd LEFT OUTER JOIN acs2014_5yr.b01003 ON (('50000US' || cd.geoid) = b01003.geoid) JOIN tiger2015.state USING (statefp)
    WHERE state.geoid NOT IN ('60', '66', '69', '78');
INSERT INTO tiger2015.census_name_lookup
    SELECT
        csa.namelsad,
        ...
        csa.awater,
        csa.geom
    FROM tiger2015.csa LEFT OUTER JOIN acs2014_5yr.b01003 ON (('33000US' || csa.geoid) = b01003.geoid);
INSERT INTO tiger2015.census_name_lookup
    SELECT
        ...
        elsd.awater,
        elsd.geom
    FROM tiger2015.elsd LEFT OUTER JOIN acs2014_5yr.b01003 ON (('95000US' || elsd.geoid) = b01003.geoid) JOIN tiger2015.state USING (statefp);
INSERT INTO tiger2015.census_name_lookup
    SELECT
        ...
        scsd.awater,
        scsd.geom
    FROM tiger2015.scsd LEFT OUTER JOIN acs2014_5yr.b01003 ON (('96000US' || scsd.geoid) = b01003.geoid) JOIN tiger2015.state USING (statefp);
INSERT INTO tiger2015.census_name_lookup
    SELECT
        ...
        puma.awater10,
        puma.geom
    FROM tiger2015.puma LEFT OUTER JOIN acs2014_5yr.b01003 ON (('79500US' || puma.geoid10) = b01003.geoid) JOIN tiger2015.state ON (puma.statefp10=state.statefp)
...
INSERT INTO tiger2015.census_name_lookup
    SELECT
        ...
        sldl.awater,
        sldl.geom
    FROM tiger2015.sldl LEFT OUTER JOIN acs2014_5yr.b01003 ON (('62000US' || sldl.geoid) = b01003.geoid) JOIN tiger2015.state USING (statefp);
INSERT INTO tiger2015.census_name_lookup
    SELECT
        ...
        sldu.awater,
        sldu.geom
    FROM tiger2015.sldu LEFT OUTER JOIN acs2014_5yr.b01003 ON (('61000US' || sldu.geoid) = b01003.geoid) JOIN tiger2015.state USING (statefp);
INSERT INTO tiger2015.census_name_lookup
    SELECT
        aiannh.namelsad,
        aiannh.namelsad,
        ...
        aiannh.awater,
        aiannh.geom
    FROM tiger2015.aiannh LEFT OUTER JOIN acs2014_5yr.b01003 ON (('25000US' || aiannh.geoid) = b01003.geoid);
INSERT INTO tiger2015.census_name_lookup
    SELECT
        aits.namelsad,
        aits.namelsad,
        ...
        aits.awater,
        aits.geom
    FROM tiger2015.aits LEFT OUTER JOIN acs2014_5yr.b01003 ON (('25100US' || aits.geoid) = b01003.geoid);
INSERT INTO tiger2015.census_name_lookup
    SELECT
        anrc.namelsad,
        anrc.namelsad,
        ...
        anrc.awater,
        anrc.geom
    FROM tiger2015.anrc LEFT OUTER JOIN acs2014_5yr.b01003 ON (('23000US' || anrc.geoid) = b01003.geoid);
INSERT INTO tiger2015.census_name_lookup
    SELECT
        ...
        bg.awater,
        bg.geom
    FROM tiger2015.bg LEFT OUTER JOIN acs2014_5yr.b01003 ON (('15000US' || bg.geoid) = b01003.geoid) JOIN tiger2015.county USING (statefp, countyfp) JOIN tiger2015.state USING (statefp)
    WHERE statefp NOT IN ('60', '66', '69', '78');
INSERT INTO tiger2015.census_name_lookup
    SELECT
        cnecta.namelsad,
        ...
        cnecta.awater,
        cnecta.geom
    FROM tiger2015.cnecta LEFT OUTER JOIN acs2014_5yr.b01003 ON (('33500US' || cnecta.geoid) = b01003.geoid);
INSERT INTO tiger2015.census_name_lookup
    SELECT
        ...
        concity.awater,
        concity.geom
    FROM tiger2015.concity LEFT OUTER JOIN acs2014_5yr.b01003 ON (('17000US' || concity.geoid) = b01003.geoid) JOIN tiger2015.state USING (statefp);
INSERT INTO tiger2015.census_name_lookup
    SELECT
        metdiv.namelsad,
        metdiv.namelsad,
        ...
        metdiv.awater,
        metdiv.geom
    FROM tiger2015.metdiv LEFT OUTER JOIN acs2014_5yr.b01003 ON (('31400US' || metdiv.geoid) = b01003.geoid);
INSERT INTO tiger2015.census_name_lookup
    SELECT
        necta.namelsad,
        necta.namelsad,
        ...
        necta.awater,
        necta.geom
    FROM tiger2015.necta LEFT OUTER JOIN acs2014_5yr.b01003 ON (('35000US' || necta.geoid) = b01003.geoid);
INSERT INTO tiger2015.census_name_lookup
    SELECT
        nectadiv.namelsad,
        nectadiv.namelsad,
        ...
        nectadiv.awater,
        nectadiv.geom
    FROM tiger2015.nectadiv LEFT OUTER JOIN acs2014_5yr.b01003 ON (('35500US' || nectadiv.geoid) = b01003.geoid);
INSERT INTO tiger2015.census_name_lookup
    SELECT
        submcd.namelsad,
        submcd.namelsad,
        ...
        submcd.awater,
        submcd.geom
    FROM tiger2015.submcd LEFT OUTER JOIN acs2014_5yr.b01003 ON (('06700US' || submcd.geoid) = b01003.geoid);
INSERT INTO tiger2015.census_name_lookup
    SELECT
        tbg.namelsad,
        tbg.namelsad,
        ...
        tbg.awater,
        tbg.geom
    FROM tiger2015.tbg LEFT OUTER JOIN acs2014_5yr.b01003 ON (('25800US' || tbg.geoid) = b01003.geoid);
INSERT INTO tiger2015.census_name_lookup
    SELECT
        ttract.namelsad,
        ttract.namelsad,
        ...
        ttract.awater,
        ttract.geom
    FROM tiger2015.ttract LEFT OUTER JOIN acs2014_5yr.b01003 ON (('25600US' || ttract.geoid) = b01003.geoid);
...
INSERT INTO tiger2015.census_name_lookup
    SELECT
        ...
        tract.awater,
        tract.geom
    FROM tiger2015.tract LEFT OUTER JOIN acs2014_5yr.b01003 ON (('14000US' || tract.geoid) = b01003.geoid) JOIN tiger2015.county USING (statefp, countyfp) JOIN tiger2015.state USING (statefp)
    WHERE statefp NOT IN ('60', '66', '69', '78');
INSERT INTO tiger2015.census_name_lookup
    SELECT
        uac.namelsad10,
        ...
        uac.awater10,
        uac.geom
    FROM tiger2015.uac LEFT OUTER JOIN acs2014_5yr.b01003 ON (('40000US' || uac.geoid10) = b01003.geoid);
INSERT INTO tiger2015.census_name_lookup
    SELECT
        ...
        unsd.awater,
        unsd.geom
    FROM tiger2015.unsd LEFT OUTER JOIN acs2014_5yr.b01003 ON (('97000US' || unsd.geoid) = b01003.geoid) JOIN tiger2015.state USING (statefp)
    WHERE statefp NOT IN ('60', '66', '69', '78');
INSERT INTO tiger2015.census_name_lookup
    SELECT
        'United States',

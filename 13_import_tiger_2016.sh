...
for i in /mnt/tmp/tiger2016/{CBSA,CD,COUNTY,CSA,PLACE,STATE,ELSD,SCSD,ZCTA5,COUSUB,PUMA,SLDL,SLDU,AIANNH,AITS,ANRC,BG,CNECTA,CONCITY,METDIV,NECTA,NECTADIV,SUBMCD,TBG,TTRACT,TABBLOCK,TRACT,UAC,UNSD}
do
    for j in $i/*.zip
    do
        unzip -q -n $j -d $i

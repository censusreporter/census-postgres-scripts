...
sed -i '1i SET search_path = acs2009_5yr, public;' *.sql
...
sed -i "s/\/<census_upload_root>\/acs2009_5yr\/All_Geographies_Not_Tracts_Block_Groups/\/mnt\/tmp\/acs2009_5yr\/geog/" /home/ubuntu/census-postgres/acs2009_5yr/import_geoheader.sql
sed -i "s/\/<census_upload_root>\/acs2009_5yr\/All_Geographies_Not_Tracts_Block_Groups/\/mnt\/tmp\/acs2009_5yr\/group1/" /home/ubuntu/census-postgres/acs2009_5yr/import_sequences.sql
sed -i "s/\/<census_upload_root>\/acs2009_5yr\/Tracts_Block_Groups_Only/\/mnt\/tmp\/acs2009_5yr\/group2/" /home/ubuntu/census-postgres/acs2009_5yr/import_sequences.sql
...
sudo -u postgres psql -f 04_drop_acs_2009_5yr_tmp_tables.sql

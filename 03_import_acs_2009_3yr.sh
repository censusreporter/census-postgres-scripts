...
sed -i '1i SET search_path = acs2009_3yr, public;' *.sql
sudo -u postgres psql -c "DROP SCHEMA IF EXISTS acs2009_3yr; CREATE SCHEMA acs2009_3yr;"
...
sed -i "s/\/<census_upload_root>\/acs2009_3yr\/All_Geographies_Not_Tracts_Block_Groups/\/mnt\/tmp\/acs2009_3yr\/geog/" /home/ubuntu/census-postgres/acs2009_3yr/import_geoheader.sql
sed -i "s/\/<census_upload_root>\/acs2009_3yr\/All_Geographies_Not_Tracts_Block_Groups/\/mnt\/tmp\/acs2009_3yr\/group1/" /home/ubuntu/census-postgres/acs2009_3yr/import_sequences.sql
sed -i "s/\/<census_upload_root>\/acs2009_3yr\/Tracts_Block_Groups_Only/\/mnt\/tmp\/acs2009_3yr\/group2/" /home/ubuntu/census-postgres/acs2009_3yr/import_sequences.sql

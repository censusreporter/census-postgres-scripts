CREATE TABLE tiger2019.aiannh252 AS (
    ...
    FROM tiger2019.aiannh
    WHERE comptyp = 'R'
);

CREATE TABLE tiger2019.aiannh254 AS (
    SELECT gid, aiannhce, aiannhns, geoid, name, namelsad, lsad, classfp,
           comptyp, aiannhr, mtfcc, funcstat, aland, awater,
           intptlat, intptlon, geom
    FROM tiger2019.aiannh
...
CREATE TABLE tiger2019.aiannh250 AS (
    ...
    FROM
        (SELECT * FROM tiger2019.aiannh WHERE comptyp = 'R') r,
        (SELECT * FROM tiger2019.aiannh WHERE comptyp = 'T') t
    ...
    WHERE comptyp = 'R'
    AND aiannhce NOT IN (
        SELECT aiannhce FROM tiger2019.aiannh WHERE comptyp = 'T'
        )
...
INSERT INTO tiger2019.census_name_lookup
    ...
    FROM tiger2019.aiannh250
    LEFT OUTER JOIN acs2018_5yr.b01003

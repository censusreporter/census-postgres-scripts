...
ALTER TABLE tiger2019.cbsa OWNER TO census;
ALTER TABLE tiger2019.cd OWNER TO census;
ALTER TABLE tiger2019.county OWNER TO census;
ALTER TABLE tiger2019.csa OWNER TO census;
ALTER TABLE tiger2019.place OWNER TO census;
ALTER TABLE tiger2019.state OWNER TO census;
ALTER TABLE tiger2019.elsd OWNER TO census;
ALTER TABLE tiger2019.scsd OWNER TO census;
ALTER TABLE tiger2019.zcta5 OWNER TO census;
ALTER TABLE tiger2019.cousub OWNER TO census;
ALTER TABLE tiger2019.puma OWNER TO census;
ALTER TABLE tiger2019.sldl OWNER TO census;
ALTER TABLE tiger2019.sldu OWNER TO census;
ALTER TABLE tiger2019.aiannh OWNER TO census;
ALTER TABLE tiger2019.aitsn OWNER TO census;
ALTER TABLE tiger2019.anrc OWNER TO census;
ALTER TABLE tiger2019.bg OWNER TO census;
ALTER TABLE tiger2019.cnecta OWNER TO census;
ALTER TABLE tiger2019.concity OWNER TO census;
ALTER TABLE tiger2019.metdiv OWNER TO census;
ALTER TABLE tiger2019.necta OWNER TO census;
ALTER TABLE tiger2019.nectadiv OWNER TO census;
ALTER TABLE tiger2019.submcd OWNER TO census;
ALTER TABLE tiger2019.tbg OWNER TO census;
ALTER TABLE tiger2019.ttract OWNER TO census;
ALTER TABLE tiger2019.tract OWNER TO census;
ALTER TABLE tiger2019.uac OWNER TO census;
ALTER TABLE tiger2019.unsd OWNER TO census;
...
DROP TABLE IF EXISTS tiger2019.census_name_lookup;
CREATE TABLE tiger2019.census_name_lookup (
...
SELECT AddGeometryColumn('tiger2019', 'census_name_lookup', 'geom', 4326, 'MULTIPOLYGON', 2);
...
INSERT INTO tiger2019.census_name_lookup
    SELECT
        ...
        state.awater,
        state.geom
    FROM tiger2019.state LEFT OUTER JOIN acs2019_1yr.b01003 ON (('04000US' || state.geoid) = b01003.geoid)
...
INSERT INTO tiger2019.census_name_lookup
    SELECT
        ...
        place.awater,
        place.geom
    FROM tiger2019.place LEFT OUTER JOIN acs2018_5yr.b01003 ON (('16000US' || place.geoid) = b01003.geoid) JOIN tiger2019.state USING (statefp)
    WHERE state.geoid NOT IN ('60', '66', '69', '78');
...
INSERT INTO tiger2019.census_name_lookup
    SELECT
        ...
        county.awater,
        county.geom
    FROM tiger2019.county LEFT OUTER JOIN acs2018_5yr.b01003 ON (('05000US' || county.geoid) = b01003.geoid) JOIN tiger2019.state USING (statefp)
    WHERE state.geoid NOT IN ('60', '66', '69', '78');
INSERT INTO tiger2019.census_name_lookup
    SELECT
        ...
        cousub.awater,
        cousub.geom
    FROM tiger2019.cousub LEFT OUTER JOIN acs2018_5yr.b01003 ON (('06000US' || cousub.geoid) = b01003.geoid) JOIN tiger2019.county USING (statefp, countyfp) JOIN tiger2019.state USING (statefp)
    WHERE state.geoid NOT IN ('60', '66', '69', '78');
INSERT INTO tiger2019.census_name_lookup
    SELECT
        zcta5.zcta5ce10,
        ...
        zcta5.awater10,
        zcta5.geom
    FROM tiger2019.zcta5 LEFT OUTER JOIN acs2018_5yr.b01003 ON (('86000US' || zcta5.geoid10) = b01003.geoid);
INSERT INTO tiger2019.census_name_lookup
    SELECT
        cbsa.namelsad,
        cbsa.name,
        ...
        cbsa.awater,
        cbsa.geom
    FROM tiger2019.cbsa LEFT OUTER JOIN acs2018_5yr.b01003 ON (('31000US' || cbsa.geoid) = b01003.geoid);
INSERT INTO tiger2019.census_name_lookup
    SELECT
        ...
        cd.awater,
        cd.geom
    FROM tiger2019.cd LEFT OUTER JOIN acs2018_5yr.b01003 ON (('50000US' || cd.geoid) = b01003.geoid) JOIN tiger2019.state USING (statefp)
    WHERE state.geoid NOT IN ('60', '66', '69', '78');
INSERT INTO tiger2019.census_name_lookup
    SELECT
        csa.namelsad,
        ...
        csa.awater,
        csa.geom
    FROM tiger2019.csa LEFT OUTER JOIN acs2018_5yr.b01003 ON (('33000US' || csa.geoid) = b01003.geoid);
INSERT INTO tiger2019.census_name_lookup
    SELECT
        ...
        elsd.awater,
        elsd.geom
    FROM tiger2019.elsd LEFT OUTER JOIN acs2018_5yr.b01003 ON (('95000US' || elsd.geoid) = b01003.geoid) JOIN tiger2019.state USING (statefp);
INSERT INTO tiger2019.census_name_lookup
    SELECT
        ...
        scsd.awater,
        scsd.geom
    FROM tiger2019.scsd LEFT OUTER JOIN acs2018_5yr.b01003 ON (('96000US' || scsd.geoid) = b01003.geoid) JOIN tiger2019.state USING (statefp);
INSERT INTO tiger2019.census_name_lookup
    SELECT
        ...
        puma.awater10,
        puma.geom
    FROM tiger2019.puma LEFT OUTER JOIN acs2018_5yr.b01003 ON (('79500US' || puma.geoid10) = b01003.geoid) JOIN tiger2019.state ON (puma.statefp10=state.statefp)
...
INSERT INTO tiger2019.census_name_lookup
    SELECT
        ...
        sldl.awater,
        sldl.geom
    FROM tiger2019.sldl LEFT OUTER JOIN acs2018_5yr.b01003 ON (('62000US' || sldl.geoid) = b01003.geoid) JOIN tiger2019.state USING (statefp);
INSERT INTO tiger2019.census_name_lookup
    SELECT
        ...
        sldu.awater,
        sldu.geom
    FROM tiger2019.sldu LEFT OUTER JOIN acs2018_5yr.b01003 ON (('61000US' || sldu.geoid) = b01003.geoid) JOIN tiger2019.state USING (statefp);
INSERT INTO tiger2019.census_name_lookup
    SELECT
        aiannh.namelsad,
        aiannh.namelsad,
        ...
        aiannh.awater,
        aiannh.geom
    FROM tiger2019.aiannh LEFT OUTER JOIN acs2018_5yr.b01003 ON (('25000US' || aiannh.geoid) = b01003.geoid);
INSERT INTO tiger2019.census_name_lookup
    SELECT
        aitsn.namelsad,
        aitsn.namelsad,
        ...
        aitsn.awater,
        aitsn.geom
    FROM tiger2019.aitsn LEFT OUTER JOIN acs2018_5yr.b01003 ON (('25100US' || aitsn.geoid) = b01003.geoid);
INSERT INTO tiger2019.census_name_lookup
    SELECT
        anrc.namelsad,
        anrc.namelsad,
        ...
        anrc.awater,
        anrc.geom
    FROM tiger2019.anrc LEFT OUTER JOIN acs2018_5yr.b01003 ON (('23000US' || anrc.geoid) = b01003.geoid);
INSERT INTO tiger2019.census_name_lookup
    SELECT
        ...
        bg.awater,
        bg.geom
    FROM tiger2019.bg LEFT OUTER JOIN acs2018_5yr.b01003 ON (('15000US' || bg.geoid) = b01003.geoid) JOIN tiger2019.county USING (statefp, countyfp) JOIN tiger2019.state USING (statefp)
    WHERE statefp NOT IN ('60', '66', '69', '78');
INSERT INTO tiger2019.census_name_lookup
    SELECT
        cnecta.namelsad,
        ...
        cnecta.awater,
        cnecta.geom
    FROM tiger2019.cnecta LEFT OUTER JOIN acs2018_5yr.b01003 ON (('33500US' || cnecta.geoid) = b01003.geoid);
INSERT INTO tiger2019.census_name_lookup
    SELECT
...
INSERT INTO tiger2019.census_name_lookup
    SELECT
        ...
        metdiv.awater,
        metdiv.geom
    FROM tiger2019.metdiv LEFT OUTER JOIN acs2018_5yr.b01003 ON (('31400US' || metdiv.geoid) = b01003.geoid);
INSERT INTO tiger2019.census_name_lookup
    SELECT
        necta.namelsad,
        necta.namelsad,
        ...
        necta.awater,
        necta.geom
    FROM tiger2019.necta LEFT OUTER JOIN acs2018_5yr.b01003 ON (('35000US' || necta.geoid) = b01003.geoid);
INSERT INTO tiger2019.census_name_lookup
    SELECT
        nectadiv.namelsad,
        nectadiv.namelsad,
        ...
        nectadiv.awater,
        nectadiv.geom
    FROM tiger2019.nectadiv LEFT OUTER JOIN acs2018_5yr.b01003 ON (('35500US' || nectadiv.geoid) = b01003.geoid);
INSERT INTO tiger2019.census_name_lookup
    SELECT
        submcd.namelsad,
        submcd.namelsad,
        ...
        submcd.awater,
        submcd.geom
    FROM tiger2019.submcd LEFT OUTER JOIN acs2018_5yr.b01003 ON (('06700US' || submcd.geoid) = b01003.geoid);
INSERT INTO tiger2019.census_name_lookup
    SELECT
        tbg.namelsad,
        tbg.namelsad,
        ...
        tbg.awater,
        tbg.geom
    FROM tiger2019.tbg LEFT OUTER JOIN acs2018_5yr.b01003 ON (('25800US' || tbg.geoid) = b01003.geoid);
INSERT INTO tiger2019.census_name_lookup
    SELECT
        ttract.namelsad,
        ttract.namelsad,
        ...
        ttract.awater,
        ttract.geom
    FROM tiger2019.ttract LEFT OUTER JOIN acs2018_5yr.b01003 ON (('25600US' || ttract.geoid) = b01003.geoid);
INSERT INTO tiger2019.census_name_lookup
    SELECT
        ...
        tract.awater,
        tract.geom
    FROM tiger2019.tract LEFT OUTER JOIN acs2018_5yr.b01003 ON (('14000US' || tract.geoid) = b01003.geoid) JOIN tiger2019.county USING (statefp, countyfp) JOIN tiger2019.state USING (statefp)
    WHERE statefp NOT IN ('60', '66', '69', '78');
INSERT INTO tiger2019.census_name_lookup
    SELECT
        uac.namelsad10,
        ...
        uac.awater10,
        uac.geom
    FROM tiger2019.uac LEFT OUTER JOIN acs2018_5yr.b01003 ON (('40000US' || uac.geoid10) = b01003.geoid);
INSERT INTO tiger2019.census_name_lookup
    SELECT
        ...
        unsd.awater,
        unsd.geom
    FROM tiger2019.unsd LEFT OUTER JOIN acs2018_5yr.b01003 ON (('97000US' || unsd.geoid) = b01003.geoid) JOIN tiger2019.state USING (statefp)
    WHERE statefp NOT IN ('60', '66', '69', '78');
INSERT INTO tiger2019.census_name_lookup
    SELECT
        'United States',
        ...
        (SELECT SUM(aland) FROM tiger2019.state),
        (SELECT SUM(awater) FROM tiger2019.state),
        (SELECT ST_Simplify(ST_Union(geom), 0.01) FROM tiger2019.state);
...
CREATE INDEX census_name_lookup_idx_geoid ON tiger2019.census_name_lookup (full_geoid);
CREATE INDEX census_name_lookup_idx_sumlevel ON tiger2019.census_name_lookup(sumlevel);

CREATE TABLE tiger2019.census_geo_containment (
    child_geoid varchar(40),
    parent_geoid varchar(40),
    percent_covered real
);
-- Places (160) in Counties (050)
INSERT INTO tiger2019.census_geo_containment (
    SELECT
    ...
    FROM tiger2019.place
    JOIN tiger2019.county ON ST_Intersects(place.geom, county.geom)
    WHERE
...
INSERT INTO tiger2019.census_geo_containment (
    ...
    FROM tiger2019.zcta5
    JOIN tiger2019.county ON ST_Intersects(zcta5.geom, county.geom)
    WHERE
...
INSERT INTO tiger2019.census_geo_containment (
    ...
    FROM tiger2019.elsd
    JOIN tiger2019.county ON ST_Intersects(elsd.geom, county.geom)
    WHERE
...
INSERT INTO tiger2019.census_geo_containment (
    ...
    FROM tiger2019.scsd
    JOIN tiger2019.county ON ST_Intersects(scsd.geom, county.geom)
    WHERE
...
INSERT INTO tiger2019.census_geo_containment (
    ...
    FROM tiger2019.unsd
    JOIN tiger2019.county ON ST_Intersects(unsd.geom, county.geom)
    WHERE
...
INSERT INTO tiger2019.census_geo_containment (
    ...
    FROM tiger2019.place
    JOIN tiger2019.cbsa ON ST_Intersects(place.geom, cbsa.geom)
    WHERE
...
INSERT INTO tiger2019.census_geo_containment (
    ...
    FROM tiger2019.zcta5
    JOIN tiger2019.cbsa ON ST_Intersects(zcta5.geom, cbsa.geom)
    WHERE
        ST_IsValid(zcta5.geom) AND
...
INSERT INTO tiger2019.census_geo_containment (
    ...
    FROM tiger2019.zcta5
    JOIN tiger2019.state ON ST_Intersects(zcta5.geom, state.geom)
    WHERE
        ST_IsValid(zcta5.geom) AND
...
INSERT INTO tiger2019.census_geo_containment (
    ...
    FROM tiger2019.cbsa
    JOIN tiger2019.state ON ST_Intersects(cbsa.geom, state.geom)
    WHERE
...
INSERT INTO tiger2019.census_geo_containment (
    ...
    FROM tiger2019.cbsa
    JOIN tiger2019.csa ON ST_Intersects(cbsa.geom, csa.geom)
    WHERE
        ST_IsValid(cbsa.geom) AND
...
INSERT INTO tiger2019.census_geo_containment (
    ...
    FROM tiger2019.csa
    JOIN tiger2019.state ON ST_Intersects(csa.geom, state.geom)
    WHERE
...
INSERT INTO tiger2019.census_geo_containment (
    ...
    FROM tiger2019.tract
    JOIN tiger2019.place ON ST_Intersects(tract.geom, place.geom)
    WHERE
...
INSERT INTO tiger2019.census_geo_containment (
    ...
    FROM tiger2019.bg
    JOIN tiger2019.place ON ST_Intersects(bg.geom, place.geom)
    WHERE
...
INSERT INTO tiger2019.census_geo_containment (
    ...
    FROM tiger2019.necta
    JOIN tiger2019.state ON ST_Intersects(necta.geom, state.geom)
    WHERE
...
CREATE INDEX census_geo_containment_idx_child_geoid ON tiger2019.census_geo_containment (child_geoid);
CREATE INDEX census_geo_containment_idx_parent_geoid ON tiger2019.census_geo_containment (parent_geoid);

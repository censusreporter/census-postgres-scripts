...
INSERT INTO tiger2023.census_name_lookup
    SELECT
        ...
        state.awater,
        state.geom
    FROM tiger2023.state LEFT OUTER JOIN acs2021_5yr.b01003 ON (('04000US' || state.geoid) = b01003.geoid)
...
INSERT INTO tiger2023.census_name_lookup
    SELECT
        ...
        place.awater,
        place.geom
    FROM tiger2023.place LEFT OUTER JOIN acs2021_5yr.b01003 ON (('16000US' || place.geoid) = b01003.geoid) JOIN tiger2023.state USING (statefp)
    WHERE state.geoid NOT IN ('60', '66', '69', '78');
...
INSERT INTO tiger2023.census_name_lookup
    SELECT
        ...
        county.awater,
        county.geom
    FROM tiger2023.county LEFT OUTER JOIN acs2021_5yr.b01003 ON (('05000US' || county.geoid) = b01003.geoid) JOIN tiger2023.state USING (statefp)
    WHERE state.geoid NOT IN ('60', '66', '69', '78');
INSERT INTO tiger2023.census_name_lookup
    SELECT
        ...
        cousub.awater,
        cousub.geom
    FROM tiger2023.cousub LEFT OUTER JOIN acs2021_5yr.b01003 ON (('06000US' || cousub.geoid) = b01003.geoid) JOIN tiger2023.county USING (statefp, countyfp) JOIN tiger2023.state USING (statefp)
    WHERE state.geoid NOT IN ('60', '66', '69', '78');
INSERT INTO tiger2023.census_name_lookup
    SELECT
        zcta520.zcta5ce20,
        ...
        zcta520.awater20,
        zcta520.geom
    FROM tiger2023.zcta520 LEFT OUTER JOIN acs2021_5yr.b01003 ON (('86000US' || zcta520.geoid20) = b01003.geoid);
INSERT INTO tiger2023.census_name_lookup
    SELECT
        cbsa.namelsad,
        cbsa.name,
        ...
        cbsa.awater,
        cbsa.geom
    FROM tiger2023.cbsa LEFT OUTER JOIN acs2021_5yr.b01003 ON (('31000US' || cbsa.geoid) = b01003.geoid);
...
INSERT INTO tiger2023.census_name_lookup
    SELECT
        ...
        cd.awater20,
        cd.geom
    FROM tiger2023.cd LEFT OUTER JOIN acs2021_5yr.b01003 ON (('50000US' || cd.geoid20) = b01003.geoid) JOIN tiger2023.state on cd.statefp20 = state.statefp
    WHERE state.geoid NOT IN ('60', '66', '69', '78');
...
INSERT INTO tiger2023.census_name_lookup
    SELECT
        ...
        csa.awater,
        csa.geom
    FROM tiger2023.csa LEFT OUTER JOIN acs2021_5yr.b01003 ON (('33000US' || csa.geoid) = b01003.geoid);
INSERT INTO tiger2023.census_name_lookup
    SELECT
        ...
        elsd.awater,
        elsd.geom
    FROM tiger2023.elsd LEFT OUTER JOIN acs2021_5yr.b01003 ON (('95000US' || elsd.geoid) = b01003.geoid) JOIN tiger2023.state USING (statefp);
INSERT INTO tiger2023.census_name_lookup
    SELECT
        ...
        scsd.awater,
        scsd.geom
    FROM tiger2023.scsd LEFT OUTER JOIN acs2021_5yr.b01003 ON (('96000US' || scsd.geoid) = b01003.geoid) JOIN tiger2023.state USING (statefp);
INSERT INTO tiger2023.census_name_lookup
    SELECT
        ...
        puma.awater20,
        puma.geom
    FROM tiger2023.puma LEFT OUTER JOIN acs2021_5yr.b01003 ON (('79500US' || puma.geoid20) = b01003.geoid) JOIN tiger2023.state ON (puma.statefp20=state.statefp)
...
INSERT INTO tiger2023.census_name_lookup
    SELECT
        ...
        sldl.awater,
        sldl.geom
    FROM tiger2023.sldl LEFT OUTER JOIN acs2021_5yr.b01003 ON (('62000US' || sldl.geoid) = b01003.geoid) JOIN tiger2023.state USING (statefp);
INSERT INTO tiger2023.census_name_lookup
    SELECT
        ...
        sldu.awater,
        sldu.geom
    FROM tiger2023.sldu LEFT OUTER JOIN acs2021_5yr.b01003 ON (('61000US' || sldu.geoid) = b01003.geoid) JOIN tiger2023.state USING (statefp);
...
INSERT INTO tiger2023.census_name_lookup
    SELECT
        ...
        anrc.awater,
        anrc.geom
    FROM tiger2023.anrc LEFT OUTER JOIN acs2021_5yr.b01003 ON (('23000US' || anrc.geoid) = b01003.geoid);
INSERT INTO tiger2023.census_name_lookup
    SELECT
...
INSERT INTO tiger2023.census_name_lookup
    SELECT
        ...
        concity.awater,
        concity.geom
    FROM tiger2023.concity LEFT OUTER JOIN acs2021_5yr.b01003 ON (('17000US' || concity.geoid) = b01003.geoid) JOIN tiger2023.state USING (statefp);
INSERT INTO tiger2023.census_name_lookup
    SELECT
        metdiv.namelsad,
        metdiv.namelsad,
        ...
        metdiv.awater,
        metdiv.geom
    FROM tiger2023.metdiv LEFT OUTER JOIN acs2021_5yr.b01003 ON (('31400US' || metdiv.geoid) = b01003.geoid);
INSERT INTO tiger2023.census_name_lookup
    SELECT
        tbg.namelsad,
        tbg.namelsad,
        ...
        tbg.awater,
        tbg.geom
    FROM tiger2023.tbg LEFT OUTER JOIN acs2021_5yr.b01003 ON (('25800US' || tbg.geoid) = b01003.geoid);
INSERT INTO tiger2023.census_name_lookup
    SELECT
        ttract.namelsad,
        ttract.namelsad,
        ...
        ttract.awater,
        ttract.geom
    FROM tiger2023.ttract LEFT OUTER JOIN acs2021_5yr.b01003 ON (('25600US' || ttract.geoid) = b01003.geoid);
INSERT INTO tiger2023.census_name_lookup
    SELECT
        ...
        tract.awater,
        tract.geom
    FROM tiger2023.tract LEFT OUTER JOIN acs2021_5yr.b01003 ON (('14000US' || tract.geoid) = b01003.geoid) JOIN tiger2023.county USING (statefp, countyfp) JOIN tiger2023.state USING (statefp)
    WHERE statefp NOT IN ('60', '66', '69', '78');
INSERT INTO tiger2023.census_name_lookup
    SELECT
        uac.namelsad20,
        ...
        uac.awater20,
        uac.geom
    FROM tiger2023.uac LEFT OUTER JOIN acs2021_5yr.b01003 ON (('40000US' || uac.geoid20) = b01003.geoid)
...
INSERT INTO tiger2023.census_name_lookup
    SELECT
        ...
        unsd.awater,
        unsd.geom
    FROM tiger2023.unsd LEFT OUTER JOIN acs2021_5yr.b01003 ON (('97000US' || unsd.geoid) = b01003.geoid) JOIN tiger2023.state USING (statefp)
    WHERE statefp NOT IN ('60', '66', '69', '78');
INSERT INTO tiger2023.census_name_lookup
    SELECT
        'United States',
